...
function Foot() {
  return (
        <div className="w-full h-screen bg-zinc-50 px-[3vw] py-[5vh] flex gap-5 font-['Neue_Montreal']">
            <div className='w-1/2 flex flex-col justify-between h-full'>
                <div className="headings">
                <h1 className="text-[10vw] font-semibold uppercase leading-[20vw] -mb-20" >Eye-</h1>
                <h1 className="text-[10vw] font-semibold uppercase leading-[10vw] -mb-20"  >Opening</h1>
                </div>
            ...
            <div className='w-1/2'>
            <h1 className="text-[6vw] font-semibold uppercase leading-tight -mb-20" >Presentations</h1>
            <div>
                <div className="dets font-['Neue_Montreal'] pt-[4vw]">
                    <h2>S:</h2>
                    <br />
                    <a className="block text-[1vw] font-light" href="#">Facebook</a>
                    <a className="block text-[1vw] font-light" href="#">LinkedInn</a>
                    <a className="block text-[1vw] font-light" href="#">Instagram</a>
                    <a className="block text-[1vw] font-light" href="#">X</a>
                </div>

                <div className="dets font-['Neue_Montreal'] pt-[4vw]">
                    <h2>S:</h2>
                    <br />
                    <a className="block text-[1vw] font-light" href="www.vaidikjsk@gmail.com">www.vaidikjsk@gmail.com</a>
                </div>
            </div>
            </div>
        </div>
